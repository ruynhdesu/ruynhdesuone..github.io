...
supportsCssVars() || alert("Please view this demo in a modern browser that supports CSS Variables.");</script>
	...
	<body class="demo-1 loading">
		<main>
			...
			<div class="content">
				<div class="grid">
					<div class="grid__item pos-2"><div class="grid__item-img" style="background-image:url(.imgimg1.png.jpg);" class="hover" ></div></div>
					<div class="grid__item pos-3"><div class="grid__item-img" style="background-image:url(./imgimg1.png.jpg);" class="hover"></div></div>
					<div class="grid__item pos-4"><div class="grid__item-img" style="background-image:url(./imgimg2.png.jpg.jpg);" class="hover"></div></div>
					<div class="grid__item pos-1"><div class="grid__item-img" style="background-image:url(./imgimg3.png.jpg);" class="hover"></div></div>
				...
				<h2 class="content__title no-select">
					<span class="content__title-sub">Chúc Thuý có một ngày tém théng 3 vui vẻ ha :>> </span>
				</h2>
			</div>
		</main>
